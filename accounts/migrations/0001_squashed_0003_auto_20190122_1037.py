...
class Migration(migrations.Migration):
    ...
    replaces = [(b'accounts', '0001_initial'), (b'accounts', '0002_auto_20190118_1831'), (b'accounts', '0003_auto_20190122_1037')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=6, unique=True, verbose_name='city pin code')),
            ],
        ),
        migrations.CreateModel(
            name='State',
